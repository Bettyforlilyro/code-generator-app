...
判断规则：
- 如果用户需求简单，内容相对固定，交互极简，无需复用组件和工程化，选择 HTML
- 如果用户需要多个页面但不涉及复杂交互，有简单交互逻辑（如验证、动画、提交等），选择 MULTI_FILE
- 如果用户需求复杂，涉及多页面、数据驱动视图、组件化开发、复杂状态管理、单页应用（SPA）需求等，选择 VUE_PROJECT
"""
